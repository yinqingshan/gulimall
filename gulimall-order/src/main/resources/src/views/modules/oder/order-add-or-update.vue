<template>
  <el-dialog
    ...
    <el-form-item label="" prop="confirmStatus">
      <el-input v-model="dataForm.confirmStatus" placeholder=""></el-input>
    </el-form-item>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/oder/order/info/${this.dataForm.id}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/oder/order/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
